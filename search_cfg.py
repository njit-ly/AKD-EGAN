...
def parse_args():
    ...
    parser.add_argument('--g_kd_lr', type=float, default=0.0002, help='learning rate of knowledge distillation for G')
    ...
    parser.add_argument('--META_UPDATE_ITER', type=int, default=300, help='iteration interval for updating the prioritized board')
    parser.add_argument('--META_STA_EPOCH', type=int, default=30, help='epoch at which meta learning begins')
    parser.add_argument('--PRIORITIZED_BOARD_STA_EPOCH', type=int, default=50, help='epoch at which prioritized board learning begins')
    parser.add_argument('--PRIORITIZED_BOARD_POOL_SIZE', type=int, default=10, help='pool size used in supernet operations')
    parser.add_argument('--PRIORITIZED_BOARD_UPDATE_ITER', type=int, default=200, help='iteration interval for updating the supernet')
